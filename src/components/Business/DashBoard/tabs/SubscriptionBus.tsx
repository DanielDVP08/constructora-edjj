...
export default function Subscription({busines}:SubscriptionProps) {
      ...
      <CardBody className="space-y-6 ml-8 mb-8">
        <div className="flex items-center space-x-4">
          <Avatar
            ...
            src={busines?.profileimage as string}
          />
          <div>
            <h2 className="ml-1 text-2xl font-bold">{busines?.businessname}</h2>
